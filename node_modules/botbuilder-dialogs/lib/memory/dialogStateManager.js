...
const conversationMemoryScope_1 = require("./scopes/conversationMemoryScope");
const turnMemoryScope_1 = require("./scopes/turnMemoryScope");
const userMemoryScope_1 = require("./scopes/userMemoryScope");
/**
...
class DialogStateManager {
    ...
    static createStandardConfiguration(conversationState, userState) {
        const config = {
            pathResolvers: [
            ...
            memoryScopes: [
                new turnMemoryScope_1.TurnMemoryScope(),
        ...
        if (conversationState) {
            config.memoryScopes.push(new conversationMemoryScope_1.ConversationMemoryScope(conversationState));
        }
        if (userState) {
            config.memoryScopes.push(new userMemoryScope_1.UserMemoryScope(userState));
        }
        return config;
    }
}
