...
export declare abstract class SkillConversationIdFactoryBase {
     ...
     */
    abstract createSkillConversationId(conversationReference: ConversationReference): Promise<string>;
    /**
     ...
     */
    abstract getConversationReference(skillConversationId: string): Promise<ConversationReference>;
    /**
